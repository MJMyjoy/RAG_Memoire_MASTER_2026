...
# Assurez-vous que le fichier CSV est dans le même dossier que le script
file_path = 'rapport_evaluation_200_mon_rag_mcqm_69p.csv'
...
plt.savefig('courbe_performance_k.png', dpi=300)
