...
# CHANGEMENT ESSENTIEL 1 : Importation depuis app_llm (qui ne contient que le client, pas de retrieve)
...
def executer_evaluation_qcm():
    ...
    print(f"🚀 Évaluation stricte lancée sur {len(questions_a_traiter)} questions QCM...")
    ...
    for item in tqdm(questions_a_traiter, desc="Traitement des QCM"):
        ...
        # CHANGEMENT ESSENTIEL 2 : Le fichier app_llm.py n'ayant pas de RAG, 
        # on définit un contexte par défaut pour éviter de faire crasher le calcul NLI.
        contexte_global = "Aucun contexte fourni (Génération directe sans RAG)."
