...
# CHANGEMENT ESSENTIEL 1 : Importation depuis app_simple et appel de 'retrieve'
from app_simple import client, retrieve 
...
def executer_evaluation_qcm():
    ...
    for item in tqdm(questions_a_traiter, desc="Traitement des QCM"):
        ...
        # CHANGEMENT ESSENTIEL 2 : Appel avec retrieve() et top_k
